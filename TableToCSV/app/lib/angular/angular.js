 ...
 * when creating reusable components, which should not accidenTableToCsv read or modify data in the
 * parent scope.
 *
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       *         When creating widgets, it is useful for the widget to not accidenTableToCsv read parent
       *         state.
       *
 ...
 * ensure that you didn't accidenTableToCsv delete the line that sanitized the value, or renamed some
 ...
 *      accidenTableToCsv introduce a bug when one updates a complex expression (imho, all regexes should
